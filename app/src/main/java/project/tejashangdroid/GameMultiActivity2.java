...
public class GameMultiActivity2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_game_multi2);
    ...
    private void createTextViews(String word)
    {
        ...
        {
            TextView textView = (TextView) getLayoutInflater().inflate(R.layout.single_letter2,null);
